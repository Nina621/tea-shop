...
<body  style="background-image: url('https://blendofbites.com/wp-content/uploads/2020/11/teapot-and-cup-of-white-tea-with-mint-leaves-2048x1365.webp'); background-size: cover; ">
	<div class="container">
		<form action="" method="POST" class="login-email">
            @csrf
			<p class="login-text" style="font-size: 2rem; font-weight: 800; color:#809fff">Login</p>
			...
			<p class="login-register-text"><a href="{{ route('auth.register') }}">Don't have an account?</a></p>
		</form>
	</div>
</body>
</html>
